  ...
  const cardClasses = `
    ...
    ${
      isLocked
        ...
        : isSelected
          ? 'border-blue-500 bg-blue-50 ring-4 ring-blue-500/30'
      ...
      <header className="flex justify-between items-start">
        <h3
          className={`font-bold text-3xl truncate ${
            isLocked ? 'text-red-900' : isSelected ? 'text-blue-900' : 'text-slate-800'
          }`}
          title={table.name}
        >
          {table.name}
      ...
      >
        <div className="flex items-center truncate">
          ...
          <span className="truncate">
            {table.customer_name || 'Consumidor'}
          </span>
        </div>
